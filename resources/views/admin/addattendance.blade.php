...
<div class="app-content content ">
    ...
    <div class="header-navbar-shadow"></div>
               <form action="{{ route('save-atten')}}" method="POST" id="edit_quarry_forsm" enctype="multipart/form-data">
                                    @csrf
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                ...
                <!--<a href="{{route('add_attendance')}}">-->
                        <div class="d-flex align-items-center">
                                            <span class="title">Date:  </span>
                                            <input type="text" name="date" id="date_pic"class="form-control invoice-edit-input date-picker" style=" margin: 0px 6px;" />
                                        </div>
                    <!--</a>-->
            </div>
        </div>
                    ...
                    <table id="quarry_table" class="datatables-basic table">
                                        ...
                                        <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input type="checkbox" class="custom-control-input chk" id="emp_id{{$employee->id}}"name="emp_id[]" value="{{$employee->emp_id}}"  />
                                ...
                                <h5 class="card-title"></h5>
                                    ...
                                    <!--<div class="form-group" style="     display: flex;     flex: 0 0 90;     flex-direction: row;     flex-wrap: nowrap;     align-content: stretch;         justify-content: space-around; ">-->
                                    <!--        <label for="title" class="form-label h3">{{$employee->name}}-({{$employee->emp_id}})</label>-->
                                    ...
                                    <!--                <div-->
                                    <!--                    class="col-md-4 custom-control custom-checkbox custom-control-inline">-->
                                    <!--                    <input type="checkbox" class="custom-control-input chk" id="emp_id{{$employee->id}}"-->
                                    ...
                                    <div class="form-group d-flex"
                                        ...
                                        <a href="{{route('attendance')}}"><button type="button" class="btn btn-outline-secondary btn-cancel"
