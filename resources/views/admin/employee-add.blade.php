                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form" method="post" action="{{ route('employee_store.store') }}" enctype="multipart/form-data">
                                        @csrf
...
@endif
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" required value="" name="name" id="name" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select select-label form-control w-100" data-placeholder="Select City" name="city" >
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Mobile" value="" required placeholder="&#43;9456824552" name="phone" id="phone" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                <label for="birth">DOJ</label>
                                                <input id="birth" type="text" class="form-control birthdate-picker" name="doj" required placeholder="YYYY-MM-DD" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" value=""  required name="email" id="email" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                <label for="password">Password</label>
                                                <input type="password" class="form-control" placeholder="password" required value="" name="password" id="password" />
                                            </div>
                                        </div>
                                         <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                <label for="website">Department</label>
                                                <input id="website" type="text" class="form-control" name="department" required placeholder="Department..." value="Stocks Audit" name="deparment" id="department" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-group">
                                                <label for="address">Address</label>
                                                <input type="text" class="form-control" placeholder="Address" value="" required name="address" id="address" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
<div class="d-flex flex-stack">
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
            <input type="checkbox" class="custom-control-input" id="dashboard" name="dashboard" value="1" checked />
        ...
        <!--end::Checkbox-->
          ...
          <!--begin::Checkbox-->
          <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
            <input type="checkbox" class="custom-control-input" id="employee" name="employee" value="1" checked />
        ...
        <!--end::Checkbox-->
         ...
         <!--begin::Checkbox-->
         <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
            <input type="checkbox" class="custom-control-input" id="production" name="production" value="1" checked />
            <label class="custom-control-label" for="production">Production</label>
        </div>
        <!--end::Checkbox-->
          <!--begin::Checkbox-->
          <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
            <input type="checkbox" class="custom-control-input" id="stock" name="stock" value="1" checked />
...
<div class="d-flex flex-stack">
    ...
    <div class="d-flex align-items-center">
              ...
              <!--begin::Checkbox-->
              <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="quarry" name="quarry" value="1" checked />
            ...
            <!--end::Checkbox-->
                ...
                <!--begin::Checkbox-->
                <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="purchase" name="purchase" value="1" checked />
                ...
                <!--begin::Checkbox-->
                <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="setting" name="setting" value="1" checked />
                    <label class="custom-control-label" for="setting">Setting</label>
                </div>
                 <div class="col-md-4 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="attendance" name="attendance" value="1"  />
