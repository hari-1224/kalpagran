                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form" method="POST" action="{{url('admin/m-production')}}" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" placeholder="Select Cutting" name="cutting_machine" id="cutting_machine">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Block Dimension" value="{{old('block_dimension')}}" name="block_dimension" id="block_dimension" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control"  value="{{old('loading_time')}}" placeholder="Loading Time" name="loading_time" id="loading_time" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="unloading_time">UnLoading Time</label>
                                                <input type="time" class="form-control"  value="{{old('unloading_time')}}" placeholder="UnLoading Time" name="unloading_time" id="unloading_time" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" placeholder="Remarks" value="{{old('remarks')}}" name="remarks" id="remarks" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                         ...
                                         <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="cutting_time" type="time" class="form-control" name="cutting_time" placeholder="Cutting Time" value="{{old('cutting_time')}}" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
