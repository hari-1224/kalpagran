                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form" method="POST" action="{{url('admin/m-epoxy')}}" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  value="{{old('block_no')}}" placeholder="Block No" name="block_no" id="block_no" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Epoxy Make" value="{{old('epoxy_make')}}" name="epoxy_make" id="epoxy_make" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Consumption" value="{{old('consumption')}}" name="consumption" id="consumption" />
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="operator_name" type="text" class="form-control" name="operator_name" placeholder="Operator Name" value="{{old('operator_name')}}" />
                                            </div>
                                        </div>
