                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form" method="POST" action="{{url('admin/m-dispatch')}}" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="customer_address" name="customer_address" value="{{old('customer_address')}}"></textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="invoice_no" type="text" class="form-control" name="invoice_no" placeholder="Invoice No" value="{{old('invoice_no')}}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="invoice_value" type="text" class="form-control" name="invoice_value" placeholder="Invoice Value" value="{{old('invoice_value')}}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="GST Amount" value="{{old('gst_amount')}}" name="gst_amount" id="gst_amount" />
                                            </div>
                                        </div>
