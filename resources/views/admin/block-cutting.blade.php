                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Blocks Cutting</a>
                                </li>
        ...
        <div class="content-body">
            ...
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" id="show_all_bcblocks">
                            </div>
                        </div>
                    </div>
                </div>
...
{{-- edit rblock --}}
<div class="modal modal-slide-in event-sidebar fade" id="editBCblockModal" tabindex="-1" aria-labelledby="editBCblockModal" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog sidebar-lg">

        <div class="modal-content p-0">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
            <div class="modal-header mb-1">
                <h5 class="modal-title">Add Block Cutting</h5>
            </div>
            <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                

                        <form action="#" method="POST" id="edit_bcblock_form" enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="bcblock_id" id="bcblock_id">
...
{{-- 
                    ...
                    <div class="mt-2" id="bd_avatar">
                        ...
                        <div class="form-group">
                            <label class="form-label">Cutting Avatar</label>
                            <input type="file" name="bc_avatar" class="form-control" >
                        </div>
                    ...
                    <div class="mt-2" id="bc_avatar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bc_length" id="bc_length" placeholder="Enter Cutting Length"  required/>
                        </div>
                        <div class="form-group">
                            <label for="title" class="form-label">Cutting Breadth</label>
                            <input type="text" class="form-control" name="bc_breadth" id="bc_breadth" placeholder="Enter Cutting Breadth"  required/>
                        </div>
                    <div class="form-group">
                        <label for="event-location" class="form-label">Block SQFT </label>
                        <input type="text" class="form-control" name="bc_sqft" id="bc_sqft" placeholder="Enter SQFT " />
                    </div>
                    <div class="form-group">
                        <label for="event-location" class="form-label">Slabe Count </label>
                        <input type="text" class="form-control" name="bc_slabscount" id="bc_slabscount" placeholder="Enter Count " />
                    </div>
                    <div class="form-group">
                        <label for="event-location" class="form-label">Machine </label>
                        <input type="text" class="form-control" name="bc_machine" id="bc_machine" placeholder="Enter Machine " />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Description</label>
                        <textarea name="bc_remark" id="bc_remark" class="form-control" ></textarea>
                    </div>

 
                    <div class="form-group d-flex">
                        <button type="submit" id="edit_bcblock_btn" class="btn btn-primary add-event-btn mr-1">Update</button>
                        <button type="button" class="btn btn-outline-secondary btn-cancel" data-dismiss="modal">Cancel</button>
                        {{-- <button type="submit" class="btn btn-primary update-event-btn d-none mr-1">Update</button>
                        <button class="btn btn-outline-danger btn-delete-event d-none">Delete</button> --}}
                    </div>
