                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    <img src="{{ asset('backend/images/portrait/small/avatar-s-11.jpg') }}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                                </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="account-username" name="username" placeholder="Username" value="muthupandiyan" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name">Name</label>
                                                            <input type="text" class="form-control" id="account-name" name="name" placeholder="Name" value="Muthu Pandiyan" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-e-mail">E-mail</label>
                                                            <input type="email" class="form-control" id="account-e-mail" name="email" placeholder="Email" value="muthupandiyan@Kalpagranites.com" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-company">Company</label>
                                                            <input type="text" class="form-control" id="account-company" name="company" placeholder="Company name" value="Kalpa Granites Pvt Ltd" />
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                                            ...
                                            <form class="validate-form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-birth-date">Join date</label>
                                                            <input type="text" class="form-control flatpickr" placeholder="Join date" id="account-birth-date" name="dob" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-website">Profile ID</label>
                                                            <input type="text" class="form-control" name="website" id="account-website" placeholder="SG00001" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-phone">Phone</label>
                                                            <input type="text" class="form-control" id="account-phone" placeholder="Phone number" value="(+91) 125 3524 125" name="phone" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="accountSwitch1">
                                                            Notify me when someone clear Stocks
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="accountSwitch2">
                                                            Notify me when someone clear Delivery
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="accountSwitch3">Notify me when Production done</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 mt-1 mb-2">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="accountSwitch4">Weekly stocks updates</label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-12 mb-75">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="accountSwitch5">Weekly Employees updates</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-primary mt-2 mr-1">Save changes</button>
