                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="SG000003" value="SG000003" name="username" id="username" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" placeholder="Email" value="employee@gmail.com" name="email" id="email" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="Sun Granite India Pvt. Ltd" placeholder="Company name" id="company" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobile" type="text" class="form-control" value="&#43;9456824552" name="phone" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <label for="website">Department</label>
                                                    <input id="website" type="text" class="form-control" placeholder="Department..." value="Stocks Audit" name="website" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <label for="languages">Locattion</label>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="address-1" type="text" class="form-control" value="A-65, bg Streets" name="address" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <label for="address-2">Address Line 2</label>
                                                    <input id="address-2" type="text" class="form-control" placeholder="T-78, Santi Street" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="city" type="text" class="form-control" value="Bangalore" name="city" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <label for="state">State</label>
                                                    <input id="state" type="text" class="form-control" name="state" placeholder="Karnataka" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <label for="country">Country</label>
                                                    <input id="country" type="text" class="form-control" name="country" placeholder="India" />
                                                </div>
                                            </div>
                                            <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                                <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Save Changes</button>
