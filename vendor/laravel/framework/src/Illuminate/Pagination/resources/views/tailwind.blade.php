@if ($paginator->hasPages())
    {{-- <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between"> --}}
        <div class="flex justify-between flex-1 sm:hidden" style= "text-align: center; font-weight:600">
        ...
        {{-- <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between"> --}}
            <div>
                <p class="text-sm text-gray-700 leading-5" style="text-align: center;margin-top:1%; font-weight:600">
                    {!! __('Showing') !!}
